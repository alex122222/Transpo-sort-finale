...
def solve_mclp(T, pop, P, walk_distance_m, time_limit_s=240, workers=8, existing_js=None):
    """
    MCLP: pick exactly P facilities to maximize covered population within walk_distance_m.
    If existing_js is provided, those facility indices are forced to be selected.
    """
    nd, ns = T.shape
